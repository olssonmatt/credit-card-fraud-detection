...
## Description
 - In this dataset, there are a number of transactions and only a small number of them are fraudulent. This allows us to calculate the percent of fraudulent transactions. To direct this into a model, we consider the percent of fraudulent transactions to be the probability of any given transaction to be linked to fraud. Consider the formula, $y = m_1*x_1 + m_2*x_2 + ... + m_n*x_n b$. In this formula, there are $x_n$ variables that influence $y$. In this case, $y$, takes the places of the probability of a fraudulent transaction, and the $x$ variables relate to the columns provided in the data set.
 - 
